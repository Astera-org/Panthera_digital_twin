import {
  ColladaLoader
} from "./chunk-BQNBSB6P.js";
import {
  STLLoader
} from "./chunk-YKOCCIUU.js";
import {
  BoxGeometry,
  CylinderGeometry,
...
var URDFJoint = class extends URDFBase {
  ...
  setJointValue(...values) {
    ...
    switch (this.jointType) {
      ...
      case "floating": {
        if (this.jointValue.every((value, index) => values[index] === value || values[index] === null))
          return didUpdate;
